...
namespace NextGenPowerToys.S3.TestApp;
...
class Program
{
    ...
    private static async Task TestFileOperations(IFileStorageService storageService, ILogger logger)
    {
        try
        {
            ...
            var testContent1 = $"Document Test File #1\nCreated: {DateTime.Now}\nContent: This is the first test document for NextGen PowerToys S3 Light testing.\nRandom ID: {Guid.NewGuid()}";
  ...
  ""id"": ""{Guid.NewGuid()}"",
  ""description"": ""This is the second test file for NextGen PowerToys S3 Light testing"",
  ""version"": 2,
  ""metadata"": {{
    ""source"": ""NextGenPowerToys.S3TestApp"",
    ""environment"": ""development""
            ...
            var uploadRequest1 = new NextGenPowerToys.Storage.S3.Light.Abstractions.DTOs.FileUploadRequest
            {
                File = testFormFile1,
                BucketName = "test-bucket",
                Tags = "test,console-app,nextgen-powertoys"
            };
            ...
            var uploadRequest2 = new NextGenPowerToys.Storage.S3.Light.Abstractions.DTOs.FileUploadRequest
            {
                File = testFormFile2,
                BucketName = "test-bucket",
